...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var medico = cadastrarMedico("Medico","medico@voll.med.com","123456",Especialidade.CARDIOLOGIA);
    ...
    @Test
    @DisplayName("Deveria devolver null quando único médico cadastrado está disponível na data, mas de especialidade diferente da consulta")
